...
function makeHexPalette(colors: HexPalette): ThemePalette {
  return {
    ...
    variables: {
      ...
      '--popover-border': hexToHsl(colors.cardBorder),
...
export const themePalettes: Record<PaletteId, ThemePalette> = {
  orbit: {
    ...
    variables: {
      ...
      '--popover': '40 43% 98%',
      '--popover-foreground': '173 29% 18%',
      '--popover-border': '39 25% 87%',
      '--primary': '170 36% 28%',
  ...
  sea: {
    ...
    variables: {
      ...
      '--popover': '204 42% 98%',
      '--popover-foreground': '211 36% 18%',
      '--popover-border': '205 28% 88%',
      '--primary': '207 61% 32%',
  ...
  coral: {
    ...
    variables: {
      ...
      '--popover': '30 60% 98%',
      '--popover-foreground': '8 28% 20%',
      '--popover-border': '22 31% 87%',
      '--primary': '8 52% 32%',
  ...
  violet: {
    ...
    variables: {
      ...
      '--popover': '260 45% 99%',
      '--popover-foreground': '252 28% 19%',
      '--popover-border': '255 28% 89%',
      '--primary': '254 43% 35%',
